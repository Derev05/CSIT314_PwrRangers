		  ...
		  <ul class="nav me-auto">
			...
			if(isset($_SESSION['username'])){
				if($_SESSION['role'] === 'Admin') {
					echo '<li class="nav-item"><a href="adminDashBoard.php" class="nav-link link-dark px-2">User Management</a></li>';
				} elseif($_SESSION['role'] === 'Buyer') {
					echo '<li class="nav-item"><a href="buyerShortlist.php" class="nav-link link-dark px-2">Your Shortlist</a></li>';
				} elseif($_SESSION['role'] === 'Seller') {
					echo '<li class="nav-item"><a href="sellerDashboard.php" class="nav-link link-dark px-2">Your Car Listings</a></li>';
	  ...
	  <header class="py-3 mb-4 border-bottom">
		<div class="container d-flex flex-wrap justify-content-center">
		  ...
		  <form class="col-12 col-lg-auto mb-3 mb-lg-0">
			<input type="search" class="form-control" placeholder="Search..." aria-label="Search" name="query" id="searchCarListing">
		  </form>
		</div>
	  </header>
</body>
